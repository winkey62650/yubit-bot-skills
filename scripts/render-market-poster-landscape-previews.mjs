...
const previews = [
  ["daily-market-brief", {
    ...
    stories: [
      ...
      { rank: "03", title: "Altcoin breadth has not confirmed a broad risk-on move", score: 64, impact: "NEUTRAL", source: "Coinbase", affected: "SOL", thesis: "Leadership remains selective rather than market-wide." },
    ],
  }],
  ["weekly-catalysts", {
    ...
    columns: [
      { label: "MON 24", events: [] },
      { label: "TUE 25", events: [{ id: "cpi", title: "U.S. Consumer Price Index", time: "12:30", importance: 3, source: "U.S. BLS", isPriority: true, affected: "BTC · ETH · DXY", sensitivity: "Rates, USD and crypto risk appetite may reprice together. Watch the first 30-minute cross-asset confirmation window." }] },
  ...
  ["data-flash", {
    ...
    verdict: "Official print verified; cross-asset confirmation remains necessary.",
  ...
  ["market-follow-up", {
    ...
    verdict: "The measured move is small and mixed; cross-asset confirmation remains incomplete.",
