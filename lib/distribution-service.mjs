...
async function flushAutomationTelemetry(repository, ruleId) {
  ...
  else if (typeof repository?.setMeta === "function") await repository.setMeta(key, null);
  return true;
}
...
async function executeAutomationRule(rule, {
  ...
  try {
    ...
    if (typeof repository?.setMeta === "function") {
      const sendingMarked = await persistAutomationExecutionState(repository, executionScope, "running", stamp, {
