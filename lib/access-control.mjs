...
// Only published editorial page routes are public, never their management APIs.
export function isPublicEditorialPath(pathname) {
  return /^\/market-calendar\/\d{4}-W\d{2}\/?$/.test(pathname)
    || /^\/data-updates\/[a-z0-9-]+\/\d{4}-\d{2}-\d{2}\/?$/.test(pathname);
}
