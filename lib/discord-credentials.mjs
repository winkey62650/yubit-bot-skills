...
export function normalizeDiscordBotToken(value) {
...
function normalizeInput(input = {}) {
  ...
  const botToken = normalizeDiscordBotToken(input.botToken);
...
export async function loadDiscordCredentials(options = {}) {
  ...
  return {
    ...
    botToken: normalizeDiscordBotToken(decryptCredential(stored.botTokenEncrypted, encryptionKeyFor(options))),
  };
}
