...
export function mergeBotGroupDiscoveries(bots = [], options = {}) {
  ...
  return [...chats.values()].map((chat) => {
    ...
    const readyForInitialization = !isChannel && allBotsAdmin && allBotIdentitiesVerified && forumReady && adminBotCanManageTopics && adminBotCanPinMessages && adminBotCanChangeInfo;
