...
export function buildAcademyDemoShowcaseContent(jobId, { now } = {}) {
  ...
  if (jobId === "crypto-daily") {
    return {
      ...
      publishable: true,
      demoShowcase: true,
      deduplicationKey: "academy-demo-replay-daily-2025-07-15-poster-v5",
  ...
  if (jobId === "weekly-calendar") {
    return {
      ...
      deduplicationKey: "academy-demo-replay-week-2025-07-14-poster-v5",
      sourceManifest: [bls],
      sources: [bls],
      document: {
  ...
  if (jobId === "data-release-updates") {
    const event = {
      id: "demo-replay-us-cpi-june-2025-poster-v5",
