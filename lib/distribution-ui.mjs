...
export function buildMarketPreviewFacts(preview = {}) {
  ...
  return {
    candidateCount: previewCollectionCount(read("candidateCount", "candidates")),
    selectedCount: previewCollectionCount(read("selectedCount", "selected")),
    missingCount: previewCollectionCount(read("missingCount", "missing")),
    conflictCount: previewCollectionCount(read("conflictCount", "conflicts")),
    nextMonitoredEvent: formatMonitoredEvent(read("nextMonitoredEvent", "nextEvent"))
  };
}
