...
import { renderMarketIntelligenceAlertText } from "./market-intelligence-alerts.mjs";
import {
...
const neutralPreviews = {
  ...
  "whale-signals": {
    ...
    branding: "neutral",
    language: "English",
    headline: "LIQUIDITY ALERT",
    caption: renderMarketIntelligenceAlertText({
      eventType: "LIQUIDITY_ALERT",
      pair: "[PAIR]",
      lifecycle: "[APPEARED / INCREASED / MOVED / REMOVED]",
      priority: "[P1 / P2 / P3]",
      fact: "Visible size [NOTIONAL] rests on the [BID / ASK] at [KEY LEVEL].",
      relativeSize: "[DEPTH SHARE]",
      distanceFromMark: "[DISTANCE]",
      depthImbalance: "[IMBALANCE]",
      interpretation: "Persistent visible liquidity may reinforce nearby support or resistance while it remains.",
      watchNext: "Track whether the level increases, moves, is absorbed or is removed.",
      source: { provider: "[VERIFIED SOURCE]", sourceTimestamp: "2026-08-26T08:00:00.000Z" }
    }),
    items: [],
    ...
    imageUrl: "/api/media/card?kind=whale&pair=BTC%20%2F%20USDT&signal=APPEARED%20BID&amount=%241.20M&price=%2460%2C000&status=P1%20%C2%B7%20POSITIVE%20%C2%B7%20SCORE%2088"
  }
};
...
export const CONTENT_TEMPLATES = {
  ...
  "whale-signals": {
    label: "Market Intelligence Alert",
    jobId: "whale-hourly",
    format: "Liquidity / Whale Flow / Position",
    recommendedSchedule: "hourly",
    destinationHint: "6. Smart Money Tracker",
    description: "持续监控市场异动；订单簿数据只生成 Liquidity Alert，钱包成交与持仓仅在专用来源可验证时启用。",
    runtimeNote: "来源、持续时间、规模、相对占比或评分任一未达门槛即不发布；同组事件冷却期内不重复发送。",
