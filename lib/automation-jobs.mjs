...
import { acknowledgeDataReleasePublished, cacheWeeklyCalendar, pollDataReleaseUpdates } from "./data-release-monitor.mjs";
import {
...
export async function runAutomationJob(jobId, options = {}) {
  ...
  try {
    ...
    if (jobId === "data-release-updates" && status === "success") {
