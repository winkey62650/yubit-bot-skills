...
export async function runAutomationJob(jobId, options = {}) {
  ...
  try {
    ...
    return recordRun({ job, slot, dryRun, status, message, target: configuredTargets, preview: { ...preview, deliveryPlans, targetResults, ...(releaseReceipt ? { deliveryReceipt: releaseReceipt } : {}) } });
  } catch (error) {
