...
function inferredStoryImpact(story) {
  ...
  const explicitEvidence = storyDirectionalEvidence(story);
  const supported = directionalImpactFromEvidence(
    explicitEvidence || `${text(story?.title)} ${text(story?.summary)}`,
  );
